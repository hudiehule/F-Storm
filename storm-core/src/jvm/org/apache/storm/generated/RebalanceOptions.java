...
public class RebalanceOptions implements org.apache.thrift.TBase<RebalanceOptions, RebalanceOptions._Fields>, java.io.Serializable, Cloneable, Comparable<RebalanceOptions> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.num_executors = new HashMap<String,Integer>(2*_map588.size);
                String _key589;
                int _val590;
                for (int _i591 = 0; _i591 < _map588.size; ++_i591)
                {
                  ...
                  struct.num_executors.put(_key589, _val590);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.num_executors != null) {
        if (struct.isSetNum_executors()) {
          oprot.writeFieldBegin(NUM_EXECUTORS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Integer> _iter592 : struct.num_executors.entrySet())
            {
              oprot.writeString(_iter592.getKey());
              oprot.writeI32(_iter592.getValue());
            }
            oprot.writeMapEnd();
          }
          oprot.writeFieldEnd();
  ...
  private static class RebalanceOptionsTupleScheme extends TupleScheme<RebalanceOptions> {
      ...
      if (struct.isSetNum_executors()) {
        {
          ...
          for (Map.Entry<String, Integer> _iter593 : struct.num_executors.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, RebalanceOptions struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TMap _map594 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.I32, iprot.readI32());
          struct.num_executors = new HashMap<String,Integer>(2*_map594.size);
          String _key595;
          int _val596;
          for (int _i597 = 0; _i597 < _map594.size; ++_i597)
          {
            ...
            struct.num_executors.put(_key595, _val596);
          }
        }
        struct.setNum_executorsIsSet(true);
      }
