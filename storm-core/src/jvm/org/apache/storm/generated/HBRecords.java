...
public class HBRecords implements org.apache.thrift.TBase<HBRecords, HBRecords._Fields>, java.io.Serializable, Cloneable, Comparable<HBRecords> {
  ...
  public int hashCode() {
    ...
    boolean present_pulses = true && (isSetPulses());
  ...
  public int compareTo(HBRecords other) {
    ...
    lastComparison = Boolean.valueOf(isSetPulses()).compareTo(other.isSetPulses());
    if (lastComparison != 0) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.pulses = new ArrayList<HBPulse>(_list842.size);
                HBPulse _elem843;
                for (int _i844 = 0; _i844 < _list842.size; ++_i844)
                {
                  _elem843 = new HBPulse();
                  _elem843.read(iprot);
                  struct.pulses.add(_elem843);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, HBRecords struct) throws org.apache.thrift.TException {
      ...
      if (struct.pulses != null) {
        oprot.writeFieldBegin(PULSES_FIELD_DESC);
        {
          ...
          for (HBPulse _iter845 : struct.pulses)
          {
      ...
      if (struct.isSetPulses()) {
        {
          ...
          for (HBPulse _iter846 : struct.pulses)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.pulses = new ArrayList<HBPulse>(_list847.size);
          HBPulse _elem848;
          for (int _i849 = 0; _i849 < _list847.size; ++_i849)
          {
            _elem848 = new HBPulse();
            _elem848.read(iprot);
            struct.pulses.add(_elem848);
          }
        }
        struct.setPulsesIsSet(true);
      }
