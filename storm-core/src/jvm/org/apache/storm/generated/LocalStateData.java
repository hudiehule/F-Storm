...
public class LocalStateData implements org.apache.thrift.TBase<LocalStateData, LocalStateData._Fields>, java.io.Serializable, Cloneable, Comparable<LocalStateData> {
  ...
  public int hashCode() {
    ...
    boolean present_serialized_parts = true && (isSetSerialized_parts());
  ...
  public int compareTo(LocalStateData other) {
    ...
    lastComparison = Boolean.valueOf(isSetSerialized_parts()).compareTo(other.isSetSerialized_parts());
    if (lastComparison != 0) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.serialized_parts = new HashMap<String,ThriftSerializedObject>(2*_map754.size);
                String _key755;
                ThriftSerializedObject _val756;
                for (int _i757 = 0; _i757 < _map754.size; ++_i757)
                {
                  _key755 = iprot.readString();
                  _val756 = new ThriftSerializedObject();
                  _val756.read(iprot);
                  struct.serialized_parts.put(_key755, _val756);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, LocalStateData struct) throws org.apache.thrift.TException {
      ...
      if (struct.serialized_parts != null) {
        oprot.writeFieldBegin(SERIALIZED_PARTS_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, ThriftSerializedObject> _iter758 : struct.serialized_parts.entrySet())
          {
  ...
  private static class LocalStateDataTupleScheme extends TupleScheme<LocalStateData> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, LocalStateData struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (Map.Entry<String, ThriftSerializedObject> _iter759 : struct.serialized_parts.entrySet())
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, LocalStateData struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      {
        ...
        struct.serialized_parts = new HashMap<String,ThriftSerializedObject>(2*_map760.size);
        String _key761;
        ThriftSerializedObject _val762;
        for (int _i763 = 0; _i763 < _map760.size; ++_i763)
        {
          _key761 = iprot.readString();
          _val762 = new ThriftSerializedObject();
          _val762.read(iprot);
          struct.serialized_parts.put(_key761, _val762);
        }
      }
      struct.setSerialized_partsIsSet(true);
    }
