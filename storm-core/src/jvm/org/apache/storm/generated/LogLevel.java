...
public class LogLevel implements org.apache.thrift.TBase<LogLevel, LogLevel._Fields>, java.io.Serializable, Cloneable, Comparable<LogLevel> {
  ...
  public int hashCode() {
    ...
    boolean present_target_log_level = true && (isSetTarget_log_level());
    list.add(present_target_log_level);
    if (present_target_log_level)
      list.add(target_log_level);

    boolean present_reset_log_level_timeout_secs = true && (isSetReset_log_level_timeout_secs());
    ...
    boolean present_reset_log_level_timeout_epoch = true && (isSetReset_log_level_timeout_epoch());
    ...
    boolean present_reset_log_level = true && (isSetReset_log_level());
  ...
  public int compareTo(LogLevel other) {
    ...
    lastComparison = Boolean.valueOf(isSetTarget_log_level()).compareTo(other.isSetTarget_log_level());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetReset_log_level_timeout_secs()).compareTo(other.isSetReset_log_level_timeout_secs());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetReset_log_level_timeout_epoch()).compareTo(other.isSetReset_log_level_timeout_epoch());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetReset_log_level()).compareTo(other.isSetReset_log_level());
    if (lastComparison != 0) {
      return lastComparison;
    }
