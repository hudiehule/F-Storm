...
public class LogConfig implements org.apache.thrift.TBase<LogConfig, LogConfig._Fields>, java.io.Serializable, Cloneable, Comparable<LogConfig> {
  ...
  public Map<String,LogLevel> named_logger_level; // optional
  ...
  public int hashCode() {
    ...
    boolean present_named_logger_level = true && (isSetNamed_logger_level());
  ...
  public int compareTo(LogConfig other) {
    ...
    lastComparison = Boolean.valueOf(isSetNamed_logger_level()).compareTo(other.isSetNamed_logger_level());
    if (lastComparison != 0) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.named_logger_level = new HashMap<String,LogLevel>(2*_map824.size);
                String _key825;
                LogLevel _val826;
                for (int _i827 = 0; _i827 < _map824.size; ++_i827)
                {
                  _key825 = iprot.readString();
                  _val826 = new LogLevel();
                  _val826.read(iprot);
                  struct.named_logger_level.put(_key825, _val826);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.named_logger_level != null) {
        if (struct.isSetNamed_logger_level()) {
          oprot.writeFieldBegin(NAMED_LOGGER_LEVEL_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, LogLevel> _iter828 : struct.named_logger_level.entrySet())
            {
      ...
      if (struct.isSetNamed_logger_level()) {
        {
          ...
          for (Map.Entry<String, LogLevel> _iter829 : struct.named_logger_level.entrySet())
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.named_logger_level = new HashMap<String,LogLevel>(2*_map830.size);
          String _key831;
          LogLevel _val832;
          for (int _i833 = 0; _i833 < _map830.size; ++_i833)
          {
            _key831 = iprot.readString();
            _val832 = new LogLevel();
            _val832.read(iprot);
            struct.named_logger_level.put(_key831, _val832);
          }
        }
        struct.setNamed_logger_levelIsSet(true);
      }
