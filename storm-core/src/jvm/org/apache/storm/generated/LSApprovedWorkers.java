...
public class LSApprovedWorkers implements org.apache.thrift.TBase<LSApprovedWorkers, LSApprovedWorkers._Fields>, java.io.Serializable, Cloneable, Comparable<LSApprovedWorkers> {
  ...
  public int hashCode() {
    ...
    boolean present_approved_workers = true && (isSetApproved_workers());
  ...
  public int compareTo(LSApprovedWorkers other) {
    ...
    lastComparison = Boolean.valueOf(isSetApproved_workers()).compareTo(other.isSetApproved_workers());
    if (lastComparison != 0) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.approved_workers = new HashMap<String,Integer>(2*_map772.size);
                String _key773;
                int _val774;
                for (int _i775 = 0; _i775 < _map772.size; ++_i775)
                {
                  ...
                  struct.approved_workers.put(_key773, _val774);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, LSApprovedWorkers struct) throws org.apache.thrift.TException {
      ...
      if (struct.approved_workers != null) {
        oprot.writeFieldBegin(APPROVED_WORKERS_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, Integer> _iter776 : struct.approved_workers.entrySet())
          {
  ...
  private static class LSApprovedWorkersTupleScheme extends TupleScheme<LSApprovedWorkers> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, LSApprovedWorkers struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (Map.Entry<String, Integer> _iter777 : struct.approved_workers.entrySet())
        {
          oprot.writeString(_iter777.getKey());
          oprot.writeI32(_iter777.getValue());
        }
      }
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, LSApprovedWorkers struct) throws org.apache.thrift.TException {
      ...
      {
        org.apache.thrift.protocol.TMap _map778 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.I32, iprot.readI32());
        struct.approved_workers = new HashMap<String,Integer>(2*_map778.size);
        String _key779;
        int _val780;
        for (int _i781 = 0; _i781 < _map778.size; ++_i781)
        {
          ...
          struct.approved_workers.put(_key779, _val780);
        }
      }
      struct.setApproved_workersIsSet(true);
    }
