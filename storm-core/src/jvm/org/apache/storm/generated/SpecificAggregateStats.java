...
public class SpecificAggregateStats extends org.apache.thrift.TUnion<SpecificAggregateStats, SpecificAggregateStats._Fields> {
  ...
  private static final org.apache.thrift.protocol.TField ACC_BOLT_FIELD_DESC = new org.apache.thrift.protocol.TField("accBolt", org.apache.thrift.protocol.TType.STRUCT, (short)3);

  /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    BOLT((short)1, "bolt"),
    SPOUT((short)2, "spout"),
    ACC_BOLT((short)3, "accBolt");
  ...
  static {
    ...
    tmpMap.put(_Fields.ACC_BOLT, new org.apache.thrift.meta_data.FieldMetaData("accBolt", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, AccBoltAggregateStats.class)));
  ...
  public static SpecificAggregateStats accBolt(AccBoltAggregateStats value) {
    SpecificAggregateStats x = new SpecificAggregateStats();
    x.setAccBolt(value);
    return x;
  }
  ...
  protected void checkType(_Fields setField, Object value) throws ClassCastException {
    switch (setField) {
      ...
      case ACC_BOLT:
        if (value instanceof AccBoltAggregateStats) {
          break;
        }
        throw new ClassCastException("Was expecting value of type AccBoltAggregateStats for field 'accBolt', but got " + value.getClass().getSimpleName());
      default:
  ...
  protected Object standardSchemeReadValue(org.apache.thrift.protocol.TProtocol iprot, org.apache.thrift.protocol.TField field) throws org.apache.thrift.TException {
    ...
    if (setField != null) {
      switch (setField) {
        ...
        case ACC_BOLT:
          if (field.type == ACC_BOLT_FIELD_DESC.type) {
            AccBoltAggregateStats accBolt;
            accBolt = new AccBoltAggregateStats();
            accBolt.read(iprot);
            return accBolt;
          } else {
            org.apache.thrift.protocol.TProtocolUtil.skip(iprot, field.type);
  ...
  protected void standardSchemeWriteValue(org.apache.thrift.protocol.TProtocol oprot) throws org.apache.thrift.TException {
    switch (setField_) {
      ...
      case SPOUT:
        ...
        return;
      case ACC_BOLT:
        AccBoltAggregateStats accBolt = (AccBoltAggregateStats)value_;
        accBolt.write(oprot);
        return;
      default:
  ...
  public AccBoltAggregateStats getAccBolt() {
    if (getSetField() == _Fields.ACC_BOLT) {
      return (AccBoltAggregateStats)getFieldValue();
    } else {
      throw new RuntimeException("Cannot get field 'accBolt' because union is currently set to " + getFieldDesc(getSetField()).name);
    }
  }

  public void setAccBolt(AccBoltAggregateStats value) {
    if (value == null) throw new NullPointerException();
    setField_ = _Fields.ACC_BOLT;
    value_ = value;
  }
  ...
  public boolean isSetAccBolt() {
    return setField_ == _Fields.ACC_BOLT;
  }
