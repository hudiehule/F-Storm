...
public class TopologyHistoryInfo implements org.apache.thrift.TBase<TopologyHistoryInfo, TopologyHistoryInfo._Fields>, java.io.Serializable, Cloneable, Comparable<TopologyHistoryInfo> {
  ...
  public int hashCode() {
    ...
    boolean present_topo_ids = true && (isSetTopo_ids());
  ...
  public int compareTo(TopologyHistoryInfo other) {
    ...
    lastComparison = Boolean.valueOf(isSetTopo_ids()).compareTo(other.isSetTopo_ids());
    if (lastComparison != 0) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.topo_ids = new ArrayList<String>(_list834.size);
                String _elem835;
                for (int _i836 = 0; _i836 < _list834.size; ++_i836)
                {
                  _elem835 = iprot.readString();
                  struct.topo_ids.add(_elem835);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TopologyHistoryInfo struct) throws org.apache.thrift.TException {
      ...
      if (struct.topo_ids != null) {
        oprot.writeFieldBegin(TOPO_IDS_FIELD_DESC);
        {
          ...
          for (String _iter837 : struct.topo_ids)
          {
      ...
      if (struct.isSetTopo_ids()) {
        {
          ...
          for (String _iter838 : struct.topo_ids)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.topo_ids = new ArrayList<String>(_list839.size);
          String _elem840;
          for (int _i841 = 0; _i841 < _list839.size; ++_i841)
          {
            _elem840 = iprot.readString();
            struct.topo_ids.add(_elem840);
          }
        }
        struct.setTopo_idsIsSet(true);
      }
