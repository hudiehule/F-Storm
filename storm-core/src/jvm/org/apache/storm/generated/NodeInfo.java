...
public class NodeInfo implements org.apache.thrift.TBase<NodeInfo, NodeInfo._Fields>, java.io.Serializable, Cloneable, Comparable<NodeInfo> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                struct.port = new HashSet<Long>(2*_set660.size);
                long _elem661;
                for (int _i662 = 0; _i662 < _set660.size; ++_i662)
                {
                  _elem661 = iprot.readI64();
                  struct.port.add(_elem661);
                }
                iprot.readSetEnd();
              }
  ...
  private static class NodeInfoTupleScheme extends TupleScheme<NodeInfo> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, NodeInfo struct) throws org.apache.thrift.TException {
      ...
      struct.setNodeIsSet(true);
      {
        org.apache.thrift.protocol.TSet _set665 = new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.I64, iprot.readI32());
        struct.port = new HashSet<Long>(2*_set665.size);
        long _elem666;
        for (int _i667 = 0; _i667 < _set665.size; ++_i667)
        {
          _elem666 = iprot.readI64();
          struct.port.add(_elem666);
        }
      }
      struct.setPortIsSet(true);
    }
