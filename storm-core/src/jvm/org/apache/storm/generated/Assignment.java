...
public class Assignment implements org.apache.thrift.TBase<Assignment, Assignment._Fields>, java.io.Serializable, Cloneable, Comparable<Assignment> {
  ...
  public Map<List<Long>,NodeInfo> executor_node_port; // optional
  public Map<List<Long>,Long> executor_start_time_secs; // optional
  ...
  public int hashCode() {
    ...
    boolean present_executor_node_port = true && (isSetExecutor_node_port());
    list.add(present_executor_node_port);
    if (present_executor_node_port)
      list.add(executor_node_port);

    boolean present_executor_start_time_secs = true && (isSetExecutor_start_time_secs());
  ...
  public int compareTo(Assignment other) {
    ...
    lastComparison = Boolean.valueOf(isSetExecutor_node_port()).compareTo(other.isSetExecutor_node_port());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetExecutor_start_time_secs()).compareTo(other.isSetExecutor_start_time_secs());
    if (lastComparison != 0) {
      return lastComparison;
    }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.node_host = new HashMap<String,String>(2*_map668.size);
                String _key669;
                String _val670;
                for (int _i671 = 0; _i671 < _map668.size; ++_i671)
                {
                  ...
                  struct.node_host.put(_key669, _val670);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.executor_node_port = new HashMap<List<Long>,NodeInfo>(2*_map672.size);
                List<Long> _key673;
                NodeInfo _val674;
                ...
                {
                  {
                    ...
                    _key673 = new ArrayList<Long>(_list676.size);
                    long _elem677;
                    for (int _i678 = 0; _i678 < _list676.size; ++_i678)
                    {
                      _elem677 = iprot.readI64();
                      _key673.add(_elem677);
                    }
                    iprot.readListEnd();
                  }
                  _val674 = new NodeInfo();
                  _val674.read(iprot);
                  struct.executor_node_port.put(_key673, _val674);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.executor_start_time_secs = new HashMap<List<Long>,Long>(2*_map679.size);
                List<Long> _key680;
                long _val681;
                ...
                {
                  {
                    ...
                    _key680 = new ArrayList<Long>(_list683.size);
                    long _elem684;
                    for (int _i685 = 0; _i685 < _list683.size; ++_i685)
                    {
                      _elem684 = iprot.readI64();
                      _key680.add(_elem684);
                    }
                    iprot.readListEnd();
                  }
                  _val681 = iprot.readI64();
                  struct.executor_start_time_secs.put(_key680, _val681);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.worker_resources = new HashMap<NodeInfo,WorkerResources>(2*_map686.size);
                NodeInfo _key687;
                WorkerResources _val688;
                for (int _i689 = 0; _i689 < _map686.size; ++_i689)
                {
                  _key687 = new NodeInfo();
                  _key687.read(iprot);
                  _val688 = new WorkerResources();
                  _val688.read(iprot);
                  struct.worker_resources.put(_key687, _val688);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.node_host != null) {
        if (struct.isSetNode_host()) {
          oprot.writeFieldBegin(NODE_HOST_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter690 : struct.node_host.entrySet())
            {
      ...
      if (struct.executor_node_port != null) {
        if (struct.isSetExecutor_node_port()) {
          oprot.writeFieldBegin(EXECUTOR_NODE_PORT_FIELD_DESC);
          {
            ...
            for (Map.Entry<List<Long>, NodeInfo> _iter691 : struct.executor_node_port.entrySet())
            {
              {
                oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I64, _iter691.getKey().size()));
                for (long _iter692 : _iter691.getKey())
                {
                  oprot.writeI64(_iter692);
                }
                oprot.writeListEnd();
              }
      ...
      if (struct.executor_start_time_secs != null) {
        if (struct.isSetExecutor_start_time_secs()) {
          oprot.writeFieldBegin(EXECUTOR_START_TIME_SECS_FIELD_DESC);
          {
            ...
            for (Map.Entry<List<Long>, Long> _iter693 : struct.executor_start_time_secs.entrySet())
            {
              {
              ...
              oprot.writeI64(_iter693.getValue());
            }
            oprot.writeMapEnd();
          }
          oprot.writeFieldEnd();
      ...
      if (struct.worker_resources != null) {
        if (struct.isSetWorker_resources()) {
          oprot.writeFieldBegin(WORKER_RESOURCES_FIELD_DESC);
          {
            ...
            for (Map.Entry<NodeInfo, WorkerResources> _iter695 : struct.worker_resources.entrySet())
            {
              _iter695.getKey().write(oprot);
  ...
  private static class AssignmentTupleScheme extends TupleScheme<Assignment> {
      ...
      if (struct.isSetNode_host()) {
        {
          ...
          for (Map.Entry<String, String> _iter696 : struct.node_host.entrySet())
          {
      ...
      if (struct.isSetExecutor_node_port()) {
        {
          ...
          for (Map.Entry<List<Long>, NodeInfo> _iter697 : struct.executor_node_port.entrySet())
          {
            {
              oprot.writeI32(_iter697.getKey().size());
              for (long _iter698 : _iter697.getKey())
              {
      ...
      if (struct.isSetExecutor_start_time_secs()) {
        {
          ...
          for (Map.Entry<List<Long>, Long> _iter699 : struct.executor_start_time_secs.entrySet())
          {
            {
              oprot.writeI32(_iter699.getKey().size());
              for (long _iter700 : _iter699.getKey())
              {
                oprot.writeI64(_iter700);
              }
            }
            oprot.writeI64(_iter699.getValue());
          }
        }
      }
      if (struct.isSetWorker_resources()) {
        {
          ...
          for (Map.Entry<NodeInfo, WorkerResources> _iter701 : struct.worker_resources.entrySet())
          {
            _iter701.getKey().write(oprot);
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, Assignment struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.node_host = new HashMap<String,String>(2*_map702.size);
          String _key703;
          String _val704;
          for (int _i705 = 0; _i705 < _map702.size; ++_i705)
          {
            ...
            struct.node_host.put(_key703, _val704);
          }
        }
        struct.setNode_hostIsSet(true);
      }
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TMap _map706 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.LIST, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.executor_node_port = new HashMap<List<Long>,NodeInfo>(2*_map706.size);
          List<Long> _key707;
          NodeInfo _val708;
          ...
          {
            {
              ...
              _key707 = new ArrayList<Long>(_list710.size);
              long _elem711;
              for (int _i712 = 0; _i712 < _list710.size; ++_i712)
              {
                _elem711 = iprot.readI64();
                _key707.add(_elem711);
              }
            }
            _val708 = new NodeInfo();
            _val708.read(iprot);
            struct.executor_node_port.put(_key707, _val708);
          }
        }
        struct.setExecutor_node_portIsSet(true);
      }
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TMap _map713 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.LIST, org.apache.thrift.protocol.TType.I64, iprot.readI32());
          struct.executor_start_time_secs = new HashMap<List<Long>,Long>(2*_map713.size);
          List<Long> _key714;
          long _val715;
          for (int _i716 = 0; _i716 < _map713.size; ++_i716)
          {
            {
              ...
              _key714 = new ArrayList<Long>(_list717.size);
              long _elem718;
              for (int _i719 = 0; _i719 < _list717.size; ++_i719)
              {
                _elem718 = iprot.readI64();
                _key714.add(_elem718);
              }
            }
            _val715 = iprot.readI64();
            struct.executor_start_time_secs.put(_key714, _val715);
          }
        }
        struct.setExecutor_start_time_secsIsSet(true);
      }
      if (incoming.get(3)) {
        {
          org.apache.thrift.protocol.TMap _map720 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRUCT, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.worker_resources = new HashMap<NodeInfo,WorkerResources>(2*_map720.size);
          NodeInfo _key721;
          WorkerResources _val722;
          for (int _i723 = 0; _i723 < _map720.size; ++_i723)
          {
            _key721 = new NodeInfo();
            _key721.read(iprot);
            _val722 = new WorkerResources();
            _val722.read(iprot);
            struct.worker_resources.put(_key721, _val722);
          }
        }
        struct.setWorker_resourcesIsSet(true);
      }
