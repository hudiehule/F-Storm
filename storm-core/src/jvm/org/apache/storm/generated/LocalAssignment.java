            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.executors = new ArrayList<ExecutorInfo>(_list764.size);
                ExecutorInfo _elem765;
                for (int _i766 = 0; _i766 < _list764.size; ++_i766)
                {
                  _elem765 = new ExecutorInfo();
                  _elem765.read(iprot);
                  struct.executors.add(_elem765);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, LocalAssignment struct) throws org.apache.thrift.TException {
      ...
      if (struct.executors != null) {
        oprot.writeFieldBegin(EXECUTORS_FIELD_DESC);
        {
          ...
          for (ExecutorInfo _iter767 : struct.executors)
          {
  ...
  private static class LocalAssignmentTupleScheme extends TupleScheme<LocalAssignment> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, LocalAssignment struct) throws org.apache.thrift.TException {
      ...
      oprot.writeString(struct.topology_id);
      {
        ...
        for (ExecutorInfo _iter768 : struct.executors)
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, LocalAssignment struct) throws org.apache.thrift.TException {
      ...
      struct.setTopology_idIsSet(true);
      {
        ...
        struct.executors = new ArrayList<ExecutorInfo>(_list769.size);
        ExecutorInfo _elem770;
        for (int _i771 = 0; _i771 < _list769.size; ++_i771)
        {
          _elem770 = new ExecutorInfo();
          _elem770.read(iprot);
          struct.executors.add(_elem770);
        }
      }
      struct.setExecutorsIsSet(true);
